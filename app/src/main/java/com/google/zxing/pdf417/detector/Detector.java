...
public final class Detector {
   ...
   * @return {@link com.google.zxing.pdf417.detector.PDF417DetectorResult} encapsulating results of detecting a PDF417 code
   * @throws com.google.zxing.NotFoundException if no PDF417 Code can be found
   */
