...
public final class Result {
  ...
  /**
   * @return {@link com.google.zxing.BarcodeFormat} representing the format of the barcode that was decoded
   */
  ...
  /**
   * @return {@link java.util.Map} mapping {@link com.google.zxing.ResultMetadataType} keys to values. May be
